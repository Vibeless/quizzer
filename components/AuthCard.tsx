...
export default function AuthCard({
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      setSocialError(getAuthErrorMessage(err?.code || ''));
    } finally {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        <div className="glass-panel p-6 sm:p-8 shadow-2xl border border-white/10 backdrop-blur-2xl bg-[#0b101d]/85">
          ...
          <div className="relative flex items-center gap-3 mb-6">
            ...
            <span className="text-[11px] font-semibold tracking-wider text-slate-500 uppercase shrink-0">
          ...
          {displayError && (
            ...
            >
              <span className="text-rose-400 shrink-0 font-bold mt-0.5">⚠️</span>
